...
assert.match(snippet, /class="apgo-cc-buybar__summary-actions"[\s\S]*?class="apgo-cc-buybar__cart-link"[\s\S]*?data-apgo-cc-buybar-chip/);
assert.match(snippet, /'product\.go_to_checkout' \| t/);
