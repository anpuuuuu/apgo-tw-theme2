...
(function () {
  ...
  function injectButtons(root) {
    ...
    $$('.product-card', root).forEach(function (card) {
      ...
      btn.innerHTML = '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>';
  ...
  function buildModal() {
    ...
    modal.innerHTML = [
      ...
      '      <div class="apgo-cc-qa-modal__qty-row">',
      '        <span class="apgo-cc-qa-modal__qty-label">數量</span>',
